export const personalInfo = {
  ...
  phone: "8113949777",
  bio: "Dedicated data analyst with a passion for transforming complex data into actionable insights. Currently pursuing a BTech in Computer Science and Engineering, I combine technical expertise with analytical problem-solving to deliver data-driven solutions. My focus areas include machine learning, statistical analysis, and data visualization.",
  resumeLink: "/amrutha.pdf"
};
...
export const education = [
  ...
  {
    id: 2,
    institution: "Chalavara Higher Secondary School",
    degree: "Computer Science, Physics, Chemistry, Mathematics",
    location: "Chalavara, Kerala",
...
export const skills = {
  technical: [
    ...
    { id: 3, name: "R", level: 80 },
    { id: 4, name: "Pandas", level: 85 },
    { id: 5, name: "NumPy", level: 80 },
    { id: 6, name: "Java", level: 75 },
    { id: 7, name: "C++", level: 70 },
    { id: 8, name: "HTML/CSS", level: 75 },
    { id: 9, name: "JavaScript", level: 70 },
    { id: 10, name: "MySQL", level: 85 }
  ],
  tools: [
    { id: 1, name: "Tableau" },
    ...
    { id: 3, name: "PyTorch" },
    { id: 4, name: "Git" },
    { id: 5, name: "Advanced Excel" }
  ],
  soft: [
    { id: 1, name: "Analytical Problem Solving" },
    { id: 2, name: "Effective Communication" },
    { id: 3, name: "Strategic Leadership" },
    { id: 4, name: "Teamwork" }
  ],
  other: [
